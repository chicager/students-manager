...
<a href="https://students-manager-webapp.herokuapp.com" target="_blank">Try app</a> (If the database has not loaded then refresh the page several times, this is due to the work of Heroku hosting)<br/>
