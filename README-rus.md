...
_/dbs_ - &nbsp;- &nbsp;папка с бд с хероку для примера. <a href="https://devcenter.heroku.com/articles/heroku-postgres-import-export" target="_blank">Как импортировать базу в heroku</a>
